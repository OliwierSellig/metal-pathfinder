  ...
  return (
    <div data-testid="discover-view">
      ...
      {state.library.isLoading ? (
        ...
        <div className="text-center py-12" data-testid="library-error">
          <div className="text-red-600 mb-4">Failed to load your library</div>
          <button
            onClick={() => window.location.reload()}
            className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"
            data-testid="retry-library-button"
          >
            Retry
          </button>
        </div>
      ) : !state.isLibraryEmpty ? (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8" data-testid="discover-main-layout">
          {/* Left Column: Form */}
          <div>
            <RecommendationForm
